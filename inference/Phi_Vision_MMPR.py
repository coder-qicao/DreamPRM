...
responses = ResponseCollector(out_path="inference/results/MMPR/Phi_vision.json")
...
for data in dataset_json:
    ...
    if not os.path.isfile(image_path):
        continue
    prompt, image = two_shots_prompt_building_single_image(input, image_path, processor)
