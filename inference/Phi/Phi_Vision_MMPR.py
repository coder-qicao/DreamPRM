...
from utils.phi_vision_utils.one_shot_CoT_prompt_building import one_shot_prompt_building_single_image
...
responses = ResponseCollector(out_path="inference/results/MMPR/Phi_vision_CoT_3000.json")

for data in dataset_json[2000:3000]:
    # example data:
    # {
    #     "id": 0,
    ...
    if not os.path.isfile(image_path):
        continue
    prompt, image = one_shot_prompt_building_single_image(input, image_path, processor)
