...
responses = ResponseCollector(out_path="inference/results/MathVision/5.json")
...
for data in dataset_json:
    ...
    response = generate_response(tokenizer, model, prompt, image_path, do_sample=True, temperature=0.6, max_new_tokens=2048)
    print(response)
